  ...
  return (
    ...
    <div className='md:w-[34.75rem] w-full h-screen md:h-[26.625rem] md:shadow md:flex md:justify-center md:items-center '>
      ...
      <div className='md:w-72 w-full h-fit md:h-[26.625rem] md:rounded-3xl md:px-6 px-4'>
        ...
        <div className=' md:bg-slate-700 md:rounded-3xl md:w-56 md:h-11  md:mt-[1.5rem] md:flex md:justify-center md:items-center md:hover:bg-gradient-to-b from-indigo-500 to-indigo-700 h-11 bg-slate-700 rounded-3xl justify-center items-center mt-8 hover:bg-gradient-to-b from-indigo-500 to-indigo-700'>
